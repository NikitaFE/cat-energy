...
function init() {
  ...
  myMap = new ymaps.Map('map', {
    ...
    center: [59.938668, 30.323020],
    zoom: 16,
    controls: []
  });

  $(".contacts__info").addClass("contacts__info--close");
  $(".contacts__map").click(function (evt) {
    evt.preventDefault();
  });
  ...
  MyBalloonLayout = ymaps.templateLayoutFactory.createClass(
      ...
      '$[[options.contentLayout observeSize minWidth=320 maxWidth=100% maxHeight=100%]]' +
      ' </div>' +
      ' </div>', {
        /**
    ...
    myPlacemark = new ymaps.Placemark(
      ...
      [59.938668, 30.323020], {
        ...
        iconImageSize: [62, 53], // размеры картинки
        iconImageOffset: [-35, -50], // смещение картинки
        balloonShadow: false,
